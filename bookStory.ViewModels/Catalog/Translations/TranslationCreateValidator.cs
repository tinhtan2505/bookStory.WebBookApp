...
{
    public class TranslationCreateValidator : AbstractValidator<TranslationCreateRequest>
    {
        public TranslationCreateValidator()
        {
            RuleFor(x => x.IdParagraph).NotEmpty().WithMessage("IdParagraph is required");
